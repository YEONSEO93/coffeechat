...
- **AWS service name:** Amazon EBS (Elastic Block Store)
- **What data is being stored?:** Application code, machine learning models, and data storage required by the server
...
- **Type of persistent connection and use:** WebSocket for real-time chat functionality
...
- **Video timestamp:** 04:08
- **Relevant files:** server/config/secretsManager.js, server/server.js

### Infrastructure as code

- **Technology used:** AWS SDK Terraform
- **Services deployed:** EC2, S3, DynamoDB, Cognito, EBS
- **Video timestamp:**
- **Relevant files:** server/terraform/main.tf, server/terraform/variables.tf
